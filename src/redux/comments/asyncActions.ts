...
//памятка для себя у арчакова сначала из селектора в пицца берутся данные 
//потом в компоненте редактируются и отправляются чере диспатч в редюсер
//потом там в экстра редюсер и из него в файл с асинхронкой