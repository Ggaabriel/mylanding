...
const ActionButton = ({chidren}: Props) => {
  ...
  return (
    <button style={{clipPath:clipButton}} className="hover:rotate-6 transition duration-500 block px-5 py-3 md:px-10 md:py-7 rounded-xl md:text-2xl text-xl bg-woodColor font-bellota text-white font-light">
        {chidren}
    </button>
  )
}
